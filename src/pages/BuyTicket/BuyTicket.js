        ...
        <div className='container confirm-route' >
            <div className='row'>
                <div className='col-sm-12'>
                    <h3 className='mt-4'>{context.listTrip[0].from} - {context.listTrip[0].arrival}</h3>
                    <p><i>{handleDate(searchParams.get("date").slice(0, 10))}</i></p>
                </div>
            </div>
            <div className='row'>
                            ...
                            <div className='col-10'>
                                ...
                                <p>
                                    <div className='row'>
                                        ...
                                        <div className='col-12 col-sm-6'><b>Điểm lên xe:</b> {list.stationStart}</div>
                                    </div>
                                </p>
                                <p>
                                    <div className='row'>
                                        ...
                                        <div className='col-12 col-sm-6'><b>Điểm xuống xe:</b> {list.stationEnd}</div>
                                    </div>
                                </p>
                            </div>
                            <div className='col-2 button-choose'>
                                <button className='btn btn-primary' id={index} onClick={handleChooseTrip}>Chọn</button>
                            </div>
                        </div>
                    </div>
                ))}
                ...
                <div className='col-lg-6'>
                    <form className='form-infor'>
                        ...
                        <div className='row m-4'>
                            ...
                            <div className='col-8'>
                                <input readOnly className='form-control' type="text" value={context.listTrip[context.id].from + " - " + context.listTrip[context.id].arrival} />
                            </div>
                        </div>
                        <div className='row m-4'>
                            <div className='col-4'>
                            ...
                            <div className='col-8'>
                                <input readOnly className='form-control' type="text" value={handleDate(context.listTrip[context.id].date.slice(0, 10))} />
                            </div>
                        </div>
                        <div className='row m-4'>
                            <div className='col-4'>
                            ...
                            <div className='col-8'>
                                <input readOnly className='form-control' type="text" value={context.listTrip[context.id].time} />
                            </div>
                        </div>
                        <div className='row m-4'>
