                ...
                <div className='col-lg-6'>
                    <form className='form-pass'>
                        <div className='row m-4'>
                            ...
                            <div className='col-8'>
                                <input className='form-control' type="password" onChange={handleOldPass} />
                        ...
                        <div className='row m-4'>
                            ...
                            <div className='col-8'>
                                <input className='form-control' type="password" onChange={handleNewPass} />
                        ...
                        <div className='row m-4'>
                            ...
                            <div className='col-8'>
                                <input className='form-control' type="password" onChange={handleConfirmPassword} />
                                <span className='text-danger'>{error.errorConfirmNewPass}</span>
                            </div>
                        </div>
                        <div className='row m-4'>
                            <div className='col-12'>
                                <button className='btn btn-secondary' type='submit' onClick={handleSubmit}>Thay đổi mật khẩu</button>
                            </div>
                        </div>
                    </form >
                </div>
