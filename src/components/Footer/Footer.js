        ...
        <footer className='container-fluid'>
            ...
            <div className='row footer'>
                ...
                <div className='col-lg-4'>
                    ...
                    <p>CÔNG TY CỔ PHẦN XE KHÁCH DT-BOOKING
                        <br />Địa chỉ: Man Thiện, Thành phố Thủ Đức, TPHCM, Việt Nam
                        <br />Email: <a className='link-color' href='mailto:hotro@dtb.vn'>hotro@dtb.vn</a>
                        <br />Điện thoại: <a className='link-color' href='tel:012345678'>012345678</a></p>
                </div>
